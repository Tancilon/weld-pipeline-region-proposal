...
def get_config():
    ...
    parser.add_argument(
        "--omni6dmug", action="store_true"
    )  # set to true if evaluating/fintuning an omni6dpose model on NOCS data
    ...
    parser.add_argument(
        "--dino", type=str, default="pointwise"
    )  # none / global / pointwise
    parser.add_argument("--scale_embedding", type=int, default=180)
    parser.add_argument("--frontend_mode", type=str, default="legacy_mask")
    parser.add_argument("--frontend_model_name", type=str, default="dinov2_vits14")
    parser.add_argument("--frontend_num_classes", type=int, default=0)
    parser.add_argument("--frontend_min_pixels", type=int, default=10)
    parser.add_argument("--frontend_score_threshold", type=float, default=0.5)
    parser.add_argument("--frontend_checkpoint_path", type=str)
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=str,
        default="score",
        help="one of the [score, energy, energy_with_ranking, scale]",
    )
    ...
    parser.add_argument(
        "--real_drop", type=int, default=10
    )  # only keep part of the frames in test set for faster inference
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="use clustering to solve multimodal issue",
    )
    parser.add_argument(
        "--clustering_eps",
        type=float,
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.4,
        help="how much to retain in outlier removal stage",
    )
    ...
    # 2D aug parameters
    cfg.DEFORM_2D_PARAMS = {"roi_mask_r": 3, "roi_mask_pro": 0.5}
